 ...
 * @author espla
 */
public class CoordinateFinderAbsencesPerDay extends javax.swing.JFrame {

    private int p1, p2, p3, p4, p5;
    
 

    public CoordinateFinderAbsencesPerDay () {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Count Absences Per Day");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Methods.countAbsencesPerDay(p1, p2, p3, p4, p5);
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
            jTextField5.setText("");
            JOptionPane.showMessageDialog(null, "ABSENCES PER DAY HAS BEEN COUNTED", "SF2 UPDATED", 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoordinateFinderAbsencesPerDay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoordinateFinderAbsencesPerDay().setVisible(true);
            }
        });
    }
